 ...
 * Update 3/18/2022 Adding itemsDateDependent refactoring surcharging to use fields in NetSuite instead of this library
 *                  so removing unneeded references
 *
 * @NApiVersion 2.1
 */
define([],
    ...
    () => {
        ...
        const chargesById = {
            ...
            15548: {surchargePercent: 0, defaultCharge: 1610.40}, //750-012-753-10
        ...
        return {DATEREF, surchargeItem, itemsDateDependent}
